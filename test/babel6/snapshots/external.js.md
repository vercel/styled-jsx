...
> Snapshot 1
    ...
    ({␊
      styles: <_JSXStyle id={"3158866088"} dynamic={[colors.green.light]}>{[`div.__jsx-style-dynamic-selector{color:${colors.green.light};}`, 'a.__jsx-style-dynamic-selector{color:red;}']}</_JSXStyle>,␊
      className: _JSXStyle.dynamic([['3158866088', [colors.green.light]]])␊
    });␊
    ␊
    const b = {␊
      styles: <_JSXStyle id={"3158866088"} dynamic={[colors.green.light]}>{[`div.__jsx-style-dynamic-selector{color:${colors.green.light};}`, 'a.__jsx-style-dynamic-selector{color:red;}']}</_JSXStyle>,␊
