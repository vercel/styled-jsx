...
## works with spread operator in jsx

> Snapshot 1

    `import _JSXStyle from 'styled-jsx/style';␊
    const Home = () => <div className={"jsx-3352088487"}>␊
        <div {...{ id: 'foo' }} className={"jsx-3352088487"}>test</div>␊
    ␊
        <_JSXStyle id={"3352088487"}>{"#foo.jsx-3352088487{background:blue;}"}</_JSXStyle>␊
      </div>;␊
    ␊
    export default (() => <div className={"jsx-826622880"}>␊
        <div {...{}} className={'jsx-826622880' + ' ' + 'foo'}>test</div>␊
    ␊
        <_JSXStyle id={"826622880"}>{".foo.jsx-826622880{background:blue;}"}</_JSXStyle>␊
      </div>);`
