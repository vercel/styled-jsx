...
> Snapshot 1
    ...
    ␊
    export default (({ display }) => <div className={'jsx-3922596756 ' + _JSXStyle.dynamic([['1795062918', [display ? 'block' : 'none']], ['412901089', [display ? 'block' : 'none']]])}>␊
        <p className={'jsx-3922596756 ' + _JSXStyle.dynamic([['1795062918', [display ? 'block' : 'none']], ['412901089', [display ? 'block' : 'none']]])}>test</p>␊
    ...
    ␊
        ...
        <_JSXStyle id={"412901089"} dynamic={[display ? 'block' : 'none']}>{`span.__jsx-style-dynamic-selector:before{display:${display ? 'block' : 'none'};content:'\\`';}`}</_JSXStyle>␊
      </div>);`
