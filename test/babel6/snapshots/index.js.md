...
> Snapshot 1
    ...
    ␊
    export default (({ display }) => <div className={'jsx-213525967 ' + _JSXStyle.dynamic([['1715223711', [color, otherColor, obj.display]], ['3820757403', [darken(color)]], ['4058989748', [darken(color) + 2]], ['1213010136', [display ? 'block' : 'none']], ['523390399', [display ? 'block' : 'none']]])}>␊
        <p className={'jsx-213525967 ' + _JSXStyle.dynamic([['1715223711', [color, otherColor, obj.display]], ['3820757403', [darken(color)]], ['4058989748', [darken(color) + 2]], ['1213010136', [display ? 'block' : 'none']], ['523390399', [display ? 'block' : 'none']]])}>test</p>␊
        <_JSXStyle id={"1715223711"} dynamic={[color, otherColor, obj.display]}>{`p.${color}.__jsx-style-dynamic-selector{color:${otherColor};display:${obj.display};}`}</_JSXStyle>␊
        <_JSXStyle id={"2743241663"}>{"p.jsx-213525967{color:red;}"}</_JSXStyle>␊
        <_JSXStyle id={"602592955"}>{`body{background:${color};}`}</_JSXStyle>␊
        <_JSXStyle id={"602592955"}>{`body{background:${color};}`}</_JSXStyle>␊
        <_JSXStyle id={"128557999"}>{`p.jsx-213525967{color:${color};}`}</_JSXStyle>␊
        <_JSXStyle id={"128557999"}>{`p.jsx-213525967{color:${color};}`}</_JSXStyle>␊
        <_JSXStyle id={"3820757403"} dynamic={[darken(color)]}>{`p.__jsx-style-dynamic-selector{color:${darken(color)};}`}</_JSXStyle>␊
        <_JSXStyle id={"4058989748"} dynamic={[darken(color) + 2]}>{`p.__jsx-style-dynamic-selector{color:${darken(color) + 2};}`}</_JSXStyle>␊
        <_JSXStyle id={"309852217"}>{`@media (min-width:${mediumScreen}){p.jsx-213525967{color:green;}p.jsx-213525967{color:${`red`};}}p.jsx-213525967{color:red;}`}</_JSXStyle>␊
        <_JSXStyle id={"2824547816"}>{`p.jsx-213525967{-webkit-animation-duration:${animationDuration};animation-duration:${animationDuration};}`}</_JSXStyle>␊
        <_JSXStyle id={"417951176"}>{`p.jsx-213525967{-webkit-animation:${animationDuration} forwards ${animationName};animation:${animationDuration} forwards ${animationName};}div.jsx-213525967{background:${color};}`}</_JSXStyle>␊
    ␊
        <_JSXStyle id={"1213010136"} dynamic={[display ? 'block' : 'none']}>{`span.__jsx-style-dynamic-selector{display:${display ? 'block' : 'none'};}`}</_JSXStyle>␊
        <_JSXStyle id={"523390399"} dynamic={[display ? 'block' : 'none']}>{`span.__jsx-style-dynamic-selector:before{display:${display ? 'block' : 'none'};content:'\\`';}`}</_JSXStyle>␊
      </div>);`
