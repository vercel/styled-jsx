...
> Snapshot 1
    ...
    ␊
    export const Test10 = () => <div className={_JSXStyle.dynamic([["1671051493", [foo]]])}>␊
        <p className={_JSXStyle.dynamic([["1671051493", [foo]]])}>dynamic with constant variable</p>␊
        <_JSXStyle id={"1671051493"} dynamic={[foo]}>{`p.__jsx-style-dynamic-selector{color:${foo};}`}</_JSXStyle>␊
