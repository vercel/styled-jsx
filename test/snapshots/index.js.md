...
> Snapshot 1
    ...
    ␊
    const Element2 = props => <Element className={_JSXStyle.dynamic([["4117347529", [props.className]]]) + " " + (props.className || "")}>␊
        {props.children}␊
        <_JSXStyle id={"4117347529"} dynamic={[props.className]}>{`.${props.className}.__jsx-style-dynamic-selector{background:green;}`}</_JSXStyle>␊
      </Element>;␊
    ␊
    export default (() => <div className={"jsx-1976894605"}>␊
        <Element className={"jsx-1976894605" + " " + "test"}>test</Element>␊
        <Element2 className={"jsx-1976894605" + " " + "test"}>test2</Element2>␊
        <_JSXStyle id={"1976894605"}>{".test.jsx-1976894605{background:red;}"}</_JSXStyle>␊
      </div>);`
