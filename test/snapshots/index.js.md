...
> Snapshot 1
    ...
    ␊
    const Element2 = props => <Element className={_JSXStyle.dynamic([["3168837404", [props.className]]]) + " " + (props.className || "")}>␊
          {props.children}␊
          <_JSXStyle id={"3168837404"} dynamic={[props.className]}>{`.${props.className}.__jsx-style-dynamic-selector{background:green;}`}</_JSXStyle>␊
       </Element>;␊
    ␊
    export default (() => <div className={"jsx-861759202"}>␊
        <Element className={"jsx-861759202" + " " + "test"}>test</Element>␊
        <Element2 className={"jsx-861759202" + " " + "test"}>test2</Element2>␊
        <_JSXStyle id={"861759202"}>{".test.jsx-861759202{background:red;}"}</_JSXStyle>␊
      </div>);`
